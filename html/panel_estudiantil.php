...
<div class="panel" id="panel-biblioteca">
  ...
  <div class="book-grid">
    <div class="book-card"><div class="book-cover" style="background:rgba(13,34,96,.07)">📐</div><div class="book-info"><div class="book-title">Matemática 4to Básico</div><div class="book-sub">Ciclo 2026 · 320 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(30,95,194,.07)">📖</div><div class="book-info"><div class="book-title">Comunicación y Lenguaje L1</div><div class="book-sub">Ciclo 2026 · 280 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(24,160,90,.07)">🔬</div><div class="book-info"><div class="book-title">Ciencias Naturales</div><div class="book-sub">Ciclo 2026 · 260 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(245,168,0,.08)">🌎</div><div class="book-info"><div class="book-title">Estudios Sociales</div><div class="book-sub">Ciclo 2026 · 240 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(217,59,43,.07)">⚡</div><div class="book-info"><div class="book-title">Física Fundamental</div><div class="book-sub">Ciclo 2026 · 300 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(147,51,234,.07)">🇬🇧</div><div class="book-info"><div class="book-title">English Connections 4</div><div class="book-sub">Ciclo 2026 · 200 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(2,132,199,.07)">💻</div><div class="book-info"><div class="book-title">Tecnología e Informática</div><div class="book-sub">Ciclo 2026 · 180 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
    <div class="book-card"><div class="book-cover" style="background:rgba(245,168,0,.07)">✝️</div><div class="book-info"><div class="book-title">Educación Cristiana</div><div class="book-sub">Ciclo 2026 · 160 págs</div><div class="book-actions"><button class="btn-book view" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
  </div>
</div>
