...
<div class="panel" id="panel-biblioteca">
  ...
  <div class="book-grid">
    ...
    <div class="book-card"><div class="book-cover" style="background:rgba(24,160,90,.07)">📒</div><div class="book-info"><div class="book-title">Contabilidad</div><div class="book-sub">Ciclo 2026</div><div class="book-actions"><button class="btn-book view" href="biblioteca/test.pdf" onclick="showToast('Abriendo libro…','success')">👁 Ver</button><button class="btn-book dl" onclick="showToast('Descargando PDF…','success')">⬇ PDF</button></div></div></div>
